...
<div class="top-section container">
		<div class="info">
			...
			<a class="main-btn overlay-btn-1"><span>Beratungstermin vereinbaren</span></a>
		</div>
		...
		<div class="benefits">
			<div class="benefit">
				...
				<div class="info">
					...
					<a href="/produkte" class="main-btn"><span>Mehr dazu</span></a>
				</div>
			</div>
			<div class="benefit">
				...
				<div class="info">
					...
					<a href="/leistungen" class="main-btn"><span>Mehr dazu</span></a>
				</div>
			</div>
		</div>
	</div>
	<div class="about container">
		<div class="info">
			...
			<a href="/ubermich" class="main-btn"><span>Um mehr zu lernen</span></a>
		</div>
	...
	<div class="bonus-cont container">
		...
		<form action="">
			<input type="text" placeholder="Name/Nachname ">
			...
			<div class="info">
				...
				<p>
					Durch Klicken auf die Schaltfläche stimmen Sie den Datenschutzbestimmungen auf der Website zu.
				</p>
			</div>
		</form>
	</div>
